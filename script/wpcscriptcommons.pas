...
begin
  case (StatementPropertyId) of
    WPC_DELAY_STATEMENT_PROPERTY_ID:       Result := 'DELAY PROPERTY';
    WPC_TILL_STATEMENT_PROPERTY_ID:        Result := 'TILL PROPERTY';
    WPC_TIMES_STATEMENT_PROPERY_ID:        Result := 'TIMES PROPERTY';
    WPC_PROBABILITY_STATEMENT_PROPERTY_ID: Result := 'PROBABILITY PROPERTY';
